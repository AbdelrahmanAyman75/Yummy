...
function showSearchInputs() {
    ...
    <div class="row py-4">
        <div class="col-md-6 ">
            <input id="searchData"  oninput="getDataBySearch()" class="form-control " type="text" placeholder="Search By Name">
        </div>
        <div class="col-md-6">
            <input id="searchletter" oninput="getDataBySearchLetter()" maxlength="1" class="form-control  " type="text" placeholder="Search By First Letter">
        </div>
    </div>`
